...
namespace Network.Crypto
{
    public class Session
    {
        ...
        public byte[] ServerKey1 = CryptoHelper.Random128Key();
        public byte[] ServerKey2 = CryptoHelper.Random128Key();
        ...
        public void Init()
        {
            TmpKey1 = CryptoHelper.ShiftKey(ServerKey1, 31);
            TmpKey2 = CryptoHelper.XorKey(TmpKey1, ClientKey1);

            TmpKey1 = CryptoHelper.ShiftKey(ClientKey2, 17, false);
            DecryptKey = CryptoHelper.XorKey(TmpKey1, TmpKey2);

            Decryptor.GenerateKey(DecryptKey);

            TmpKey1 = CryptoHelper.ShiftKey(ServerKey2, 79);
